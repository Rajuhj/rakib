...
prinCP=[]
try:
    prox= requests.get('https://github.com/Rajuhj/Approva/blob/main/Approva').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/Rajuhj/Approva/blob/main/Approva').text
        ua=open('bbnew.txt','w')
...
def back():
    login()
def contact():
    os.system('xdg-open https://facebook.com/groups/1146411920073246//?ref=share')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
    for e in u + "\n":sys.stdout.write(e);sys.stdout.flush();time.sleep(0.01)
os.system('https://www.facebook.com/peteverbooke.kosterjiboon')
logo =(f"""
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
╠══[Facebook                 • RATUL RATUL   ║  \033[1;97m  
╠══[Github                   • \33[1;38mRaja1234 ║\33[1;34m   
╠══[Whatsapp                 • 01732370826    ║\33[1;35m 
╠══[TOOLS                    • PAID ]         ║ \33[1;32m   
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Rajuhj/Approva/blob/main/Approva').text
    if id in httpCaht:
      print(fuckyoursali)
...
def menu():
    ...
    if ASIF in ['111']:
        ...
        os.system('xdg-open https://github.com/Rajuhj/Approva/blob/main/Approva')
        os.system("python nono.py")
    elif ASIF in ['3','03']:
        result()
    elif ASIF in ['0']:
